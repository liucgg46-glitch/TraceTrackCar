...
#define BALL_BALANCE_NATURAL_FREQ_RAD_S                 1.6f
 ...
 */
#define BALL_BALANCE_VELOCITY_FILTER_TIME_S             0.050f
#define BALL_BALANCE_VELOCITY_DEADBAND_MM_S             3.0f
#define BALL_BALANCE_DISTURBANCE_FILTER_TIME_S          0.200f
#define BALL_BALANCE_DISTURBANCE_COMPENSATION_GAIN      0.0f
#define BALL_BALANCE_REFERENCE_ACCEL_FEEDFORWARD_GAIN   0.0f
#define BALL_BALANCE_DYNAMIC_FILTER_TIME_S              0.060f
#define BALL_BALANCE_DYNAMIC_HARD_LIMIT_DEG             3.0f
 ...
 */
#define BALL_BALANCE_SERVO_MAX_SPEED_DEG_S              60.0f
#define BALL_BALANCE_SERVO_MAX_ACCEL_DEG_S2             1200.0f
#define BALL_BALANCE_SERVO_TRACK_TIME_S                 0.080f
 ...
 */
#define BALL_BALANCE_BREAKAWAY_MIN_ERROR_MM             8.0f
#define BALL_BALANCE_BREAKAWAY_CLEAR_ERROR_MM           6.0f
#define BALL_BALANCE_BREAKAWAY_DWELL_MS                 300U
#define BALL_BALANCE_BREAKAWAY_START_DEG                0.3f
#define BALL_BALANCE_BREAKAWAY_MAX_DEG                  1.0f
#define BALL_BALANCE_BREAKAWAY_GROWTH_DEG_S             0.5f
#define BALL_BALANCE_BREAKAWAY_RELEASE_DEG_S            3.0f
#define BALL_BALANCE_BREAKAWAY_STUCK_SPEED_MM_S         8.0f
#define BALL_BALANCE_BREAKAWAY_RELEASE_SPEED_MM_S       12.0f
#define BALL_BALANCE_BREAKAWAY_PROGRESS_MM              0.5f
#define BALL_BALANCE_BREAKAWAY_PROGRESS_COUNT           2U
#define BALL_BALANCE_BREAKAWAY_VALID_AGE_MS             60U
