...
#define CONTROL_CHASSIS_TARGET_SLEW_STEP_CPS       400
...
#define CONTROL_LINE_BASE_SPEED_CPS               1800    /* 中线正常循迹速度 */
...
#define CONTROL_LINE_KP                           0.40f    /* 比例增大：转弯更积极；过大易摆动 */
#define CONTROL_LINE_KD                           0.18f    /* 微分增大：回正更快、抑制过冲；过大易抖动 */
#define CONTROL_LINE_ERROR_DEADBAND               80      /* 误差死区：±80 内按 0 处理 */
#define CONTROL_LINE_SPEED_FULL_ERROR             300     /* |误差|≤200 保持全速 */
#define CONTROL_LINE_SPEED_MIN_ERROR              2000    /* |误差|≥1500 降到最低速度 */
