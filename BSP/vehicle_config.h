...
/* 亚博 STM32 串口示例明确使用 115200、8N1。 */
#ifndef YAHBOOM_GRAY_UART_BAUDRATE
#define YAHBOOM_GRAY_UART_BAUDRATE         115200UL
#endif
...
#define VEHICLE_YAHBOOM_UART_ENABLE        1U
...
#define VEHICLE_YAHBOOM_UART_ENABLE        0U
